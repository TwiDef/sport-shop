...
const NotFoundPage = () => {
    ...
    return (
        <div style={{ color: "#fff", height: "100vh", display: 'flex', justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
            <div style={{ height: "400px", backgroundImage: "url('https://static.insales-cdn.com/images/products/1/5908/538515220/large_large_large_hit_4.png')", backgroundSize: "contain", backgroundRepeat: "no-repeat", textShadow: "4px 4px 7px #000", display: "flex", flexDirection: "column", gap: "20px" }}>
